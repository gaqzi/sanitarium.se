...
[{% img alt="'Automating' comes from the roots 'auto-' meaning 'self-', and
'mating', meaning 'screwing'." https://imgs.xkcd.com/comics/automation.png %}](https://xkcd.com/1319)
...
{% img alt="Opening Firefox in Alfred" /img/2024/04/15/01-open-app.png %}
...
{% img alt="Finding the correct spelling of continuus"
/img/2024/04/15/02-spell-continuous.png %}
...
{% img alt="Define 'laggard'" /img/2024/04/15/03-define-laggard.png %}
...
{% img alt="Adding some numbers together" /img/2024/04/15/04-calculator.png %}
...
{% img alt="Alfred's setting Features -> Web Search highlighted"
/img/2024/04/15/05-web-search-listing.png %}
...
{% img alt="Example setup of the Confluence search engine"
/img/2024/04/15/06-web-search-example-config.png %}
...
{% img alt="The custom app shortcuts workflow"
/img/2024/04/15/07-app-shortcuts.png %}
...
{% img alt="Spotify keybinding and keyword configuration"
/img/2024/04/15/08-spotify-keybindings.png %}
...
{% img alt="The mic switch workflow setup" /img/2024/04/15/09-mic-switch.png %}
...
{% img alt="How to view or create snippets"
/img/2024/04/15/11-snippets-config.png %}
...
{% img alt="Configuring the jiramd snippet in Alfred"
/img/2024/04/15/12-snippet-jiramd.png %}
...
{% img alt="Searching for the rocket emoji"
/img/2024/04/15/10-search-emoji.png %}
...
{% img alt="Configuring the uuidgen snippet"
/img/2024/04/15/15-snippet-uuidgen.png %}
...
{% img alt="How configure the Copy to clipboard output"
/img/2024/04/15/16-snippet-uuidgen-clipboard-config.png %}
...
{% img alt="Calculate Anything converting 16 floz to ml"
/img/2024/04/15/13-calculate-anything.png %}
...
{% img alt="Epoch Converter showing the current unix timestamp at the time of
writing" /img/2024/04/15/14-epoch-converter.png %}

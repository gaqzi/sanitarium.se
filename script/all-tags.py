...
def collect_all_tags(content_dir='content'):
    ...
    print(f"Processed {processed_files} files, found {len(tag_counts)} unique tags", file=sys.stderr)
    return tag_counts
...
def main():
    parser = argparse.ArgumentParser(description='Collect tags from blog markdown files')
    parser.add_argument('-d', '--directory', default='content',
